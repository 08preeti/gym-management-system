...
app.post('/api/members', (req, res) => {
  ...
  const newMember = {
    id: uuidv4(), name, email, phone: phone || '', dob: dob || '',
    gender: gender || 'Male', plan: plan || 'Basic', fee: fee || 'Monthly - $49.99',
...
app.put('/api/products/:id', (req, res) => {
  ...
  if (req.body.price) products[idx].price = parseFloat(req.body.price);
...
app.listen(PORT, () => {
  ...
  console.log(`   GET    /api/members        POST /api/members`);
  console.log(`   GET    /api/members/:id    PUT  /api/members/:id    DELETE /api/members/:id`);
  console.log(`   POST   /api/members/:id/checkin`);
  console.log(`   GET    /api/bills          POST /api/bills`);
  console.log(`   GET    /api/bills/:id      PUT  /api/bills/:id      DELETE /api/bills/:id`);
  console.log(`   GET    /api/notifications  POST /api/notifications`);
  console.log(`   PUT    /api/notifications/:id/read`);
  console.log(`   PUT    /api/notifications/read-all`);
  console.log(`   GET    /api/products       POST /api/products`);
  console.log(`   GET    /api/products/:id   PUT  /api/products/:id   DELETE /api/products/:id`);
